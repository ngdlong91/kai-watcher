...
// DecodeInputData returns decoded transaction input data if it matches any function in staking and validator contract.
...
func UnpackLog(log *types.Log, smcABI *abi.ABI) (*types.Log, error) {
